...
public class NewShopCategoryPageCrawler extends BaseCrawler implements Runnable {

    private String pageUrl;
    private String categoryName;

    public NewShopCategoryPageCrawler(ServletContext context, String pageUrl,
            String categoryName) {
        super(context);
    ...
    public void run() {
        ...
        if (category == null) {
            Logger.getLogger(NewShopCategoryPageCrawler.class.getName())
